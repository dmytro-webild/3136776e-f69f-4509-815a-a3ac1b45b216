...
export default function LandingPage() {
  ...
  <div id="featured-properties" data-section="featured-properties">
      ...
      products={[
        {
          id: "p1",          name: "فيلا فاخرة في تلال الإمارات",          price: "35,000,000 درهم",          variant: "للبيع",          imageSrc: "http://img.b2bpic.net/free-photo/young-woman-with-albinism-spending-time-home_23-2150321723.jpg?_wi=2",          imageAlt: "Luxury villa in Emirates Hills"},
        {
          id: "p2",          name: "شقة بنتهاوس بإطلالة على برج خليفة",          price: "12,000,000 درهم",          variant: "للبيع",          imageSrc: "http://img.b2bpic.net/free-photo/minimalist-architecture-space_23-2151912524.jpg?_wi=2",          imageAlt: "Penthouse apartment with Burj Khalifa view"},
        {
          id: "p3",          name: "منزل تاون هاوس حديث في دبي هيلز",          price: "5,800,000 درهم",          variant: "للبيع",          imageSrc: "http://img.b2bpic.net/free-photo/vertical-shot-pathway-kilkenny-dukesmeadows_181624-27700.jpg?_wi=2",          imageAlt: "Modern townhouse in Dubai Hills"},
        {
          id: "p4",          name: "فيلا شاطئية حصرية في نخلة جميرا",          price: "50,000,000 درهم",          variant: "للبيع",          imageSrc: "http://img.b2bpic.net/free-photo/modern-bathroom-with-big-mirror_1203-1497.jpg?_wi=2",          imageAlt: "Exclusive beachfront villa in Palm Jumeirah"},
        {
          id: "p5",          name: "شقة فاخرة بغرفتي نوم في وسط مدينة دبي",          price: "3,200,000 درهم",          variant: "للإيجار",          imageSrc: "http://img.b2bpic.net/free-photo/woman-using-digital-assistant-her-tablet_23-2149108007.jpg?_wi=2",          imageAlt: "Luxury 2-bedroom apartment in Downtown Dubai"},
        {
          id: "p6",          name: "فيلا واسعة بـ 5 غرف نوم في المرابع العربية",          price: "9,500,000 درهم",          variant: "للبيع",          imageSrc: "http://img.b2bpic.net/free-photo/view-bedroom-with-futuristic-decor-style_23-2151151759.jpg?_wi=2",          imageAlt: "Spacious 5-bedroom villa in Arabian Ranches"},
      ]}
